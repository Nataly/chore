...
/**
 * This is the model class for table "ntipoevento".
 *
 * The followings are the available columns in table 'ntipoevento':
 * @property integer $id
 ...
 */
class Ntipoevento extends CActiveRecord
{
	/**
	 * Returns the static model of the specified AR class.
	 * @return Ntipoevento the static model class
	 */
	...
	public function rules()
	{
		...
		return array(
			array('id, tipoEvento, usuario_modifico, fecha_modifico', 'required'),
			array('id', 'numerical', 'integerOnly'=>true),
			array('tipoEvento', 'length', 'max'=>50),
			array('usuario_modifico', 'length', 'max'=>45),
			// The following rule is used by search().
			// Please remove those attributes that should not be searched.
			array('id, tipoEvento, usuario_modifico, fecha_modifico', 'safe', 'on'=>'search'),
		);
	}
	...
	public function relations()
	{
		...
		return array(
			'neventos' => array(self::HAS_MANY, 'Nevento', 'TipoEvento_id'),
		);
	}
